...
## [Inspecting](https://zero.rocicorp.dev/docs/debug/replication\#inspecting)
...
```
Copy$ npx @rocicorp/zero-sqlite3 /tmp/my-zero-replica.db
```

[💡Zero uses the bedrock version of SQLite](https://zero.rocicorp.dev/docs/debug/replication#sqlite-version)
...
## [Miscellaneous](https://zero.rocicorp.dev/docs/debug/replication\#miscellaneous)
...
[PreviousSlow Queries](https://zero.rocicorp.dev/docs/debug/slow-queries)

[NextQuery ASTs](https://zero.rocicorp.dev/docs/debug/query-asts)

### On this page

[Resetting](https://zero.rocicorp.dev/docs/debug/replication#resetting) [Inspecting](https://zero.rocicorp.dev/docs/debug/replication#inspecting) [Miscellaneous](https://zero.rocicorp.dev/docs/debug/replication#miscellaneous)

[Edit this page on GitHub](https://github.com/rocicorp/zero-docs/blob/main/contents/docs/debug/replication.mdx)