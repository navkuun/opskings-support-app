...
import { ResponseTimePageClient } from "@/components/response-time/response-time-page-client"

export const metadata: Metadata = {
  title: "Response Time",
  description: "Response time distribution, overdue tickets, and expected vs actual analysis.",
}
