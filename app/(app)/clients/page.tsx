...
import { ClientAnalysisPageClient } from "@/components/clients/client-analysis-page-client"
...
export const metadata: Metadata = {
  title: "Clients",
  description: "Client insights and spending summary.",
}
...
export default async function Page() {
  ...
  return <ClientAnalysisPageClient />
}
